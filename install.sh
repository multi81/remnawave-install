...
echo -e "${BLUE}[6/6] Настройка страницы подписки...${NC}"
...
# --- Настройка прокси ---
echo -e "${BLUE}[Доп] Настройка прокси ($PROXY)...${NC}"
if [[ "$PROXY" == "caddy" ]]; then
...
echo -e "  ▶ Ожидание инициализации БД и Redis (20 секунд)..."
sleep 20
...
check_container "remnawave-redis"
check_container "remnawave"
...
if $INSTALL_NODE; then
    ...
    echo -e "  4. Установите ноду на целевом сервере"
fi
